    ...
    <div>
      <div className="container">
        <div className="who-i-am">
          <h1>Who I am</h1>
          <p>My name's Aatmik. I'm a Full Stack developer based in India.</p>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo sunt
            neque unde enim repellat accusamus nihil, aliquid ex maiores,
            dolores error itaque beatae. Est unde laboriosam, voluptates cum
            officiis soluta?
          </p>
        </div>
